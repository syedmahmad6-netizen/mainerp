...
class FeeReport extends Page {
    ...
    public function form(Form $form): Form {
        return $form->schema([
            ...
            Forms\Components\Select::make('section_id')->label('Filter by Section (optional)')
                ->options(fn()=>Section::with('schoolClass')->get()->mapWithKeys(fn($s)=>[$s->id=>$s->schoolClass->name.' – '.$s->name]))
                ->nullable()->placeholder('All Sections')->searchable(),
