 ...
 * Access: gnosis.ac.pk/super-admin
 * Who:    Only users with role = super_admin
 * Scope:  NO tenant scoping — sees all schools
 */
class SuperAdminPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->path('super-admin')
            ->login()
            ->brandName('Gnosis — Platform Admin')
            ...
            ->middleware([
                ...
                // NOTE: No IdentifyTenant here — Super Admin has no tenant
            ])
